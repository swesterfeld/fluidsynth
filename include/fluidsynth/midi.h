 ...
 */
typedef int (*handle_midi_event_func_t)(void* data, fluid_event_t* event);
...
FLUIDSYNTH_API int fluid_midi_dump_prerouter(void* data, fluid_event_t* event); 
FLUIDSYNTH_API int fluid_midi_dump_postrouter(void* data, fluid_event_t* event); 
